<template>
    <div>
        <div class="sn-must-floor">
            <div class="sn-floor1-title">{{floor1.title}}</div>
            <div class="sn-floor1-img">
                <ul>
                    <li class="must-floor1" :key="i" v-for="(n,i) in floor1Src">
        ...
        <div class="sn-must-floor2">
            <div class="floor2-poster">
                <img :src="floor2.poster" alt="">
                <p>{{floor2.desc}}</p>
            </div>
                <sn-must-two :data="floor2Src"></sn-must-two>
        </div>

<!--        第二个类似模块-->
        <div class="sn-must-floor">
            <div class="sn-floor1-title">{{floor3.title}}</div>
            <div class="sn-floor1-img">
                <ul>
                    <li class="must-floor1" :key="i" v-for="(n,i) in floor3Src">
                        <img :src="n.src" alt=""><br>
                        <div class="sale">
        ...
        <div class="sn-must-floor2">
            <div class="floor2-poster">
                <img :src="floor4.poster" alt="">
                <p>{{floor4.desc}}</p>
            </div>
            <sn-must-two :data="floor4Src"></sn-must-two>
        </div>
